...
max_range = [20 16.6 6];      %m (x,y,z)
plot_data = true;
z_layer_to_plot = 1;       %if plot_data=true, the cell_z to plot 2D slices
...
% FORMAT: U, V, W, x, y, z
filename = strcat(folder_path,'wind_at_cell_center_points_2msX_drone1_0.csv');
...
%Outlet_1: left door ->  Xcell = 25, 0<Ycell<21 and Zcell<6
Env(end:end,:,:) = 2;
Env(:,end:end,:) = 2;
Env(:,:,end:end) = 2;
